    ...
    if a[0]==3:
        ...
        if e>=4:
            if a[1]==4:
                ...
                a4["bg"]='yellow'
                l1.configure(text="YOU LOST")
    if a[0]==2 or a[0]==4 or a[0]==6 or a[0]==8:
        a5["text"]='X'
        a5["bg"]='yellow'
        if e==2:
            e=e+1
...
root.iconbitmap("C:/Users/DELL/Desktop/My file/program(python)/spider/Dapino-Summer-Holiday-Palm-tree.ico")
